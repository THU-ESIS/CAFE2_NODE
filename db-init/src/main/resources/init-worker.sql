...
(
    ...
    activity              VARCHAR(1024) COLLATE utf8_bin NOT NULL,
    ...
    mip_table             VARCHAR(1024) COLLATE utf8_bin NOT NULL,
    grid_label            VARCHAR(1024) COLLATE utf8_bin NOT NULL,
    dataset_version       VARCHAR(1024) COLLATE utf8_bin NOT NULL,
    ...
    INDEX ix_mip_era (mip_era),
    INDEX ix_activity (activity),
    ...
    INDEX ix_grid_label (grid_label),
    INDEX ix_dataset_version (dataset_version),
